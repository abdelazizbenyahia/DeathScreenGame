...
void Hero::mouse(const df::EventMouse *p_mouse_event) {
  ...
  if ((p_mouse_event->getMouseAction() == df::CLICKED) &&
    ...
    fire(viewToWorld(p_mouse_event->getMousePosition()));
}
...
void Hero::move(int dy) {
  ...
  if ((new_pos.getY() > 3) && 
    ...
    world_manager.moveObject(p_reticle,viewToWorld(df::InputManager::getMousePosition()));
  }
}
